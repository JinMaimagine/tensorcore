...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgCData(oldp+0,(vlSelf->top__DOT__op_in_r),2);
        bufp->chgCData(oldp+1,(vlSelf->top__DOT__a_in_r),6);
        bufp->chgCData(oldp+2,(vlSelf->top__DOT__b_in_r),6);
        bufp->chgBit(oldp+3,(vlSelf->top__DOT__in_valid_r));
        bufp->chgCData(oldp+4,(vlSelf->top__DOT__result),6);
    }
